...
const HeadingBlue: FC<HeadingProps> = ({title}) => {
    return(
        ...
        <div className="text-center"> 
            <h2 className="text-[1.65rem] xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-blue-600 mb-6 sm:mb-8 relative inline-block group cursor-pointer text-center leading-tight">
